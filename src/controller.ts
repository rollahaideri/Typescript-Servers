...
export async function LoginController(request: FastifyRequest<{Body: LoginRequest}>, reply: FastifyReply) {
    console.log(request.body);    
}

export async function RegisterController(request: FastifyRequest<{Body: IUser}>, reply: FastifyReply) {
try {
